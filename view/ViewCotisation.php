          		...
          		<fieldset>
            		...
            		<div class="row">
                        ...
                        <!-- Nombre de ticket -->
                  		...
                  		<!-- Utilisateur -->
                  		<input type="hidden" id="choix_utilisateur" name="choix_utilisateur" value="<?= unserialize($_SESSION['user'])->getId()?>"></input>
                  		<input type="hidden" id="mode" name="mode" value="user"></input>
